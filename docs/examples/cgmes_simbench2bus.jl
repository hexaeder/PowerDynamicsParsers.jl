...
=#
@hover inspect_collection(dataset; edge_labels=false, node_labels=:short, size=(1000,1000))
...
@hover inspect_collection(no_diagram; edge_labels=false, node_labels=:short, size=(1000,1000))
