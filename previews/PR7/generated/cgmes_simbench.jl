...
inspect_collection(nodes[1]; edge_labels=false, node_labels=:short, size=(1000,1000))
...
eresid[604]
inspect_collection(edges[604]; edge_labels=true, node_labels=:short, size=(1000,1000))
