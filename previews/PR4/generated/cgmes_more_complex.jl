...
inspect_collection(nodes[6]; size=(900,900))



inspect_collection(edges[10].metadata[:branches][1]; size=(900,900))

inspect_collection(edges[10].metadata[:branches][2]; size=(900,900))

inspect_collection(edges[10].metadata[:branches][3]; size=(900,900))
